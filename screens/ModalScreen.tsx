...
export default function ModalScreen() {
    ...
    const playSound = async () => {
        ...
        const playit = await sound.playAsync();
        console.log(JSON.stringify(playit))
    };
    ...
    const __takePicture = async () => {
        //TODO disable default sound before playing...
        // await playSound()
    ...
    const __savePhoto = () => {
        ...
        /*//crop it...
        //TODO need to calculate the crop area
        ...
        console.log('capturedImage to save...', capturedImage)
                    ...
                    {previewVisible && capturedImage ? (
                        ...
                        <>
                            ...
                            <View style={
                                ...
                                <TouchableOpacity key={"bolt"}
                                                  style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}
                                                  onPress={__handleFlashMode} disabled={actionsDisabled}>
                                    <MaterialIcons name={flashMode === 'off' ? 'no-flash' : 'flash-on'} style={{
                                        fontSize: 30,
                                        color: 'purple',
                                        transform: [{rotate: '90deg'}]
                                    }}/>
                                </TouchableOpacity>
                                <TouchableOpacity key={"photo-camera"}
                                                  style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}
                                                  onPress={__takePicture} disabled={actionsDisabled}>
                                    <MaterialIcons name={"photo-camera"} style={{
                                        fontSize: 50,
                                        color: 'purple',
                                        transform: [{rotate: '90deg'}]
                                    }}/>
                                ...
                                <TouchableOpacity key={"cancel"}
                                                  style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}
                                                  onPress={__cancelCamera} disabled={actionsDisabled}>
                                    <MaterialIcons name={"cancel"} style={{
                                        fontSize: 30,
                                        color: 'purple',
                                        transform: [{rotate: '90deg'}]
                                    }}/>
    ...
    return (
        ...
        >
            ...
            <View style={
                ...
                <TouchableOpacity key={"photo-camera"} style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}
                                  onPress={retakePicture}>
                    <MaterialIcons name={"photo-camera"} style={{fontSize: 50, color: 'purple'}}/>
                    <Text style={{color: 'purple'}}>Retake</Text>
                </TouchableOpacity>
                <TouchableOpacity key={"check-circle"} style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}
                                  onPress={savePhoto}>
